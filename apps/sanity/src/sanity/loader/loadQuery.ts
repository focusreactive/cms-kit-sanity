...
import { landingPageQuery } from '@/components/cms-kit-components-set/content-blocks/sanity/pages/landing/sa/landingPageQuery'
...
export function loadHomePage() {
  return loadQuery<LandingPayload | null>(
    landingPageQuery,
    { slug: 'home' },
    { next: { tags: ['home', 'post'] } },
  )
...
export function loadLanding(slug: string) {
  return loadQuery<LandingPayload | null>(
    ...
    { slug },
    {
      ...
      // CHECK: do we need previewDrafts?

 ...
 *
 * 1. Copy the BlockTemplate folder to a new folder with the desired component name.
 * 2. Rename the component, schema, and template names from BlockTemplate to your chosen name.
 * 3. Import all elements of your new component in the files within the `blocks` folder, similar to how BlockTemplate is imported.

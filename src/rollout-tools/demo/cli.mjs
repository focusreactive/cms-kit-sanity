...
async function localRollout({ inputs, secrets }) {
  ...
  try {
    ...
    try {
      ...
      console.error(
        'Failed to add environment variables to Vercel project.',
        error,
      );
      throw error;
    }
    ...
    try {
      ...
      console.error('Failed to add Sanity CORS entry.', error);
      throw error;
    }
    ...
    try {
      ...
      console.error('Failed to invite user to Sanity project.', error);
      throw error;
    }
    ...
    try {
      ...
      console.error('Failed to create a new Sanity dataset.', error);
      throw error;
    }
    ...
    try {
      ...
      console.error('Failed to fill the dataset with data.', error);
      throw error;
    }
    ...
    try {
      ...
      console.error('Failed to add deploy hook to Sanity project.', error);
      throw error;
    }
    ...
    try {
      ...
      console.error('Failed to create a new Vercel deployment.', error);
      throw error;
    }
    ...
    console.error('One of the steps was not successful 😿');
